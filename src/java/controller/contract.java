...
public class contract extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        Station s = sdao.selectSationByLocation(pickuplocation);
        ...
        Contract c = new Contract(cid+"_"+pickupdate, cid,pickupdatetime, dropoffdatetime, s.getStationID(), s.getStationID(), customer.getUsername(), diff*car.getDailyprice());
        cdao.addContract(c);
