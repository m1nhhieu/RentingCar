 ...
 * @author Dell
 */
@WebServlet(name="admincustomersearch", urlPatterns={"/admincustomersearch"})
public class admincustomersearch extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        String cname = request.getParameter("customersearch");
        ...
        if(cname.length()==0){
            ...
            List<Customer> adminCustomer = cudao.getAllCustomerByName(cname);
            session.setAttribute("adminCustomer", adminCustomer);
        }
        String curlink = "account";
