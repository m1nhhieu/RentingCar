...
public class editstation extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        if(request.getParameter("stationid")!=null){
            ...
            session.setAttribute("editstation", station);
            ...
            int carAvailable = Integer.parseInt( request.getParameter("carAvailable"));
            String pickupLocation = request.getParameter("pickupLocation");
            String country = request.getParameter("country");
            String city = request.getParameter("city");
        
        Station s = new Station(station.getStationID(), address, carAvailable, pickupLocation, country, city);
