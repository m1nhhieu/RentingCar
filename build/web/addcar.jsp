        ...
        <div class="container">
            <main>
                ...
                <div class="row g-5" style="justify-content: center;">
                    ...
                    <div class="col-md-8">
                        <form class="needs-validation" action="addcar" method="post" enctype="multipart/form-data">
                            <div class="row g-3">
                                

                                <div class="col-sm-6">
                                    <label for="carname" class="form-label">Car Name</label>
                                    <input name="carname" type="text" class="form-control" id="carname" required>
                                ...
                                <div class="my-3 col-sm-6">
                                    ...
                                    <div class="form-check">
                                        <input value="0" id="available1" name="available" type="radio" class="form-check-input">
                                        <label class="form-check-label" for="available1">0</label>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <label for="priceid" class="form-label">Price Id</label>
                                    <select name="priceid" class="form-control" required="">
                                        <%
                                ...
                                <div class="col-12">
                                    ...
                                    <input required="" name="numberofseats" type="number" class="form-control" id="numberofseats" placeholder="5,7,10,...">
                                </div>
                                <div class="col-12">
                                    <label for="numberoflargebags" class="form-label">Number of Large Bags</label>
                                    <input required="" name="numberoflargebags" type="number" class="form-control" id="numberoflargebags" placeholder="1,2,3,...">
                                </div>
                                <div class="col-12">
                                    <label for="numberofsmallbags" class="form-label">Number of Small Bags</label>
                                    <input required="" name="numberofsmallbags" type="number" class="form-control" id="numberofsmallbags" placeholder="1,2,3,...">
                                </div>
