...
<html>
    ...
    <body>
                    ...
                    <main>
                        <div class="row g-5" style="justify-content: center;">
                            ...
                            <div class="col-md-8 filter">
                                <form class="needs-validation" novalidate action="contract?cid=<%=cid%>" method="post">
        ...
        <%
        List<Car> similarCarList = (List<Car>)session.getAttribute("similarCarList");
        %>
                ...
                %>
                        <div class="col-md-4">
                            <div class="item row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
                                ...
                                <div class="col-md-6">
                                    <img style="width: 100%;" src="<%=car1.getImgage()%>" >
                                </div>

                                <div class="col-md-6 p-4 d-flex flex-column position-static">
                                    <h3 style="min-height: 66.7px;" class="mb-0"><%=car1.getName()%></h3>
                                    <div class="row">
                                            <div class="description"><i class="bi bi-person"></i> <%=car1.getNumberOfSeats()%> seats</div>
                                            <div class="description"><i class="bi bi-suitcase-lg"></i> <%=car1.getLargeBags()%> large bag</div>
                                        <div class="description"><i class="bi bi-suitcase"></i> <%=car1.getSmallBags()%> small bag</div>
                                    </div>
                                        
                                    <a href="#" class="icon-link gap-1 icon-link-hover">
                                        <%=car1.getPickuplocation()%>
                                    </a>
                                    <div class="row" style="margin-top: 20px">

                                            <p class="item-title">Price for <%=diff%> days:</p>
                                            <h5>$<%=car1.getDailyprice()*diff%> </h5>
                                        
                                    </div>
                                    <div class="row" >   
                                            <a href="detail?cid=<%=car1.getCarID()%>" class="btn btn-warning">View deal</a>
                                    </div>
                                ...
                                <div class="review row" style="margin-left: 0px;">
                                    <div class="col-md-2 review-score" style="width: 52px;">
                                        <%=car1.getReviewScore()%>
                                        <%
                                        float score = car1.getReviewScore();
                                        String mark = "";
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div style="opacity: 0.8;"> <%=car1.getReviewer()%> Reviews</div>
                                    </div>
                                </div>
                            </div>
                        </div>
