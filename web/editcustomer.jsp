                        ...
                        <form class="needs-validation" action="editcustomer" method="post">
                            <div class="row g-3">
                                <div class="col-sm-6">
                                    ...
                                    <input value="<%=firstname%>" name="firstname" type="text" class="form-control" id="firstname" required>

                                </div>

                                <div class="col-sm-6">
                                    <label for="lastname" class="form-label">Last name</label>
                                    <input value="<%=lastname%>" name="lastname" type="text" class="form-control" id="lastname" placeholder="" required>
                                ...
                                <div class="my-3 col-sm-6">
                                    ...
                                    <div class="form-check">
                                        <input <%=gender.equals("male")?"checked":""%> value="male" id="gender1" name="gender" type="radio" class="form-check-input">
                                        <label class="form-check-label" for="gender1">Male</label>
                                    </div>
                                    <div class="form-check">
                                        <input <%=gender.equals("female")?"checked":""%> value="female" id="gender2" name="gender" type="radio" class="form-check-input">
                                ...
                                <div class="col-12">
                                    ...
                                    <input disabled="" value="<%=username%>" type="text" name="username" class="form-control" id="username" placeholder="Username">
                                </div>
                                <div class="col-12">
                                ...
                                <div class="col-12">
                                    ...
                                    <select class="form-control" id="role" name="role">
                                        <option <%=role.equals("admin")?"selected":""%> value="admin">Admin</option>
                                        <option <%=role.equals("customer")?"selected":""%> value="customer">Customer</option>
                                    </select>
                                </div>
